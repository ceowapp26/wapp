  ...
  return (
    <div className="w-full py-6 flex flex-col gap-3 items-center">
      {currentStep !== 2 && (
        <Button
          type="submit"
          className="w-full bg-black text-slate-50 dark:bg-white dark:text-gray-800 dark:hover:bg-gray-300 hover:text-black hover:bg-slate-100"
      ...
      {currentStep === 2 && (
        <Button
          type="submit"
          className="w-full bg-black dark:bg-white dark:text-gray-800 dark:hover:bg-gray-300 text-slate-50 hover:text-black hover:bg-slate-100"
        >
