...
const ExtensionPriceCard = () => {
  const extensions = [
    { name: 'Productivity Pack', price: 4.99, features: ['Task Manager', 'Calendar Integration', 'Notes Sync'] },
        ...
        {extensions.map((extension, index) => (
          ...
          >
            <div className="p-6">
              ...
              <p className="text-3xl font-bold mb-4">${extension.price}<span className="text-sm font-normal">/month</span></p>
