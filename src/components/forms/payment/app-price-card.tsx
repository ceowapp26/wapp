...
const AppPriceCard = () => {
  const apps = [
    { name: 'Basic Suite', price: 9.99, features: ['3 Apps', 'Basic Support', '1GB Storage'] },
        ...
        {apps.map((app, index) => (
          ...
          >
            <div className="p-6">
              ...
              <p className="text-3xl font-bold mb-4">${app.price}<span className="text-sm font-normal">/month</span></p>
