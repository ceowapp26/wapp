  ...
  return (
    <div className="w-full py-6 flex flex-col gap-3 items-center">
      {(currentStep === 1 && providerType === "email-w-password") || currentStep === 2 ? (
        <Button type="submit" className="w-full bg-black text-slate-50 hover:text-gray-800 hover:bg-slate-700">
          Sign In
        </Button>
      ) : null}
      {currentStep === 1 && providerType !== "email-w-password" ? (
        <Button
          type="submit"
          className="w-full bg-black text-slate-50 hover:text-gray-800 hover:bg-slate-700"
