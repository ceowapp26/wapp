...
import { AIDashboardNodeView } from "../views";
...
const AIDashboardNode = (props: any) => {  
  ...
  return (
    <StyleWrapper>
      <DashBoardTitle>AI-Generated DashBoard</DashBoardTitle>
      <DashBoardContainer>
        {isLoading ? (
          <LoadingOverlay>Loading DashBoard...</LoadingOverlay>
        ) : (
          <AIDashboardNodeView data={props.node.attrs.data.default} />
        )}
      </DashBoardContainer>
    </StyleWrapper>
  );
...
AIDashboardNode.displayName = "AIDashboardNode";

export { AIDashboardNode };
