...
const uploadKey = new PluginKey("upload-unsplash-image");
...
export const UploadUnsplashImagesPlugin = ({ imageClass }: { imageClass: string }) =>
  new Plugin({
    key: uploadKey,
    state: {
      init(): DecorationSet {
...
export const createUnSplashImage = (url: string, view: EditorView, pos: number) => {
  const id = {};
