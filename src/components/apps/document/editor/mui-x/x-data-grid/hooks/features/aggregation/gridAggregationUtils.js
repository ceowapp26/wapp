...
import { removeNodeFromTree, insertNodeInTree } from '../../../utils/tree/utils';
...
export const getAggregationFunctionLabel = ({
  ...
  try {
    return apiRef.current.getLocaleText(`aggregationFunctionLabel${_utils.unstable_capitalize(aggregationRule.aggregationFunctionName)}`);
  } catch (e) {
