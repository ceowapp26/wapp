...
export const getAggregationValueWrappedValueGetter = ({
  value: valueGetter,
...
export const getAggregationValueWrappedValueFormatter = ({
...
export const getAggregationValueWrappedRenderCell = ({
  value: renderCell,
  aggregationRule,
  getCellAggregationResult
}) => {
    ...
    if (cellAggregationResult != null) {
      if (!renderCell) {
        if (cellAggregationResult.position === 'footer') {
          return /*#__PURE__*/_jsx(GridFooterCell.GridFooterCell, _extends({}, params));
        }
 ...
 */
export const getWrappedFilterOperators = ({
 ...
 */
export const getWrappedRenderHeader = ({
  value: renderHeader,
  aggregationRule
}) => {
...
export const wrapColumnWithAggregationValue = ({
  ...
  const getCellAggregationResult = (id, field) => {
    ...
    const aggregationResult = _gridAggregationSelectors.gridAggregationLookupSelector(apiRef)?.[groupId]?.[field];
...
export const unwrapColumnFromAggregation = ({
  ...
  const _ref = column,
    ...
    unwrappedColumn = _objectWithoutPropertiesLoose2(_ref, _excluded);
