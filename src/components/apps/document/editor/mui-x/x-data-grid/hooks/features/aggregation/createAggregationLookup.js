...
export const getAggregationCellValue = ({
  apiRef,
  groupId,
  field,
  aggregationFunction,
...
export const getGroupAggregatedValue = ({
  groupId,
  apiRef,
  aggregationRowsScope,
  aggregatedFields,
...
export const createAggregationLookup = ({
  ...
  const aggregationRules = _gridAggregationUtils.getAggregationRules({
  ...
  const createGroupAggregationLookup = groupNode => {
    ...
    const hasAggregableChildren = groupNode.children && groupNode.children.length;
