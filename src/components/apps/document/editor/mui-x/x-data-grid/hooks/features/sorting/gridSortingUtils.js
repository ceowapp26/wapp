...
export const isDesc = direction => direction === 'desc';
 ...
 */
export const parseSortItem = (sortItem, apiRef) => {
 ...
 */
export const compareRows = (parsedSortItems, row1, row2) => {
...
export const gridNillComparator = (v1, v2) => {
  if (v1 == null && v2 != null) {
    return -1;
  }
  if (v2 == null && v1 != null) {
