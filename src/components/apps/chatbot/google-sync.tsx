    ...
    if (validated) {
      try {
        ...
        if (_files) {
          ...
          usePortalStore.persist.setOptions({
...
const GooglePopup = ({
  ...
  const setToastStatus = usePortalStore((state) => state.setToastStatus);
  const setToastMessage = usePortalStore((state) => state.setToastMessage);
  const setToastShow = usePortalStore((state) => state.setToastShow);
