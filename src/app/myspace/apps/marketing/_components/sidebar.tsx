...
const menuItems = [
  { icon: LayoutDashboard, name: 'Dashboard', href: '/myspace/apps/marketing/dashboard' },
  { icon: Rocket, name: 'Campaigns', href: '/myspace/apps/marketing/campaigns' },
  { icon: Users, name: 'CRM', href: '/myspace/apps/marketing/crm' },
  { icon: Search, name: 'SEO', href: '/myspace/apps/marketing/seo' },
  { icon: Globe, name: 'Social Management', href: '/myspace/apps/marketing/social' },
  { icon: MessageSquare, name: 'Ad Management', href: '/myspace/apps/marketing/advertisement' },
  { icon: BarChart2, name: 'Analytics', href: '/myspace/apps/marketing/analytics' },
  { icon: Mail, name: 'Email Marketing', href: '/myspace/apps/marketing/email' },
];
        ...
        {!isCollapsed && (
          ...
          >
            <div className="flex justify-between items-center p-4 border-b dark:border-gray-700">
              <h2 className="text-xl font-bold text-gray-800 dark:text-white">Wapp-Marketing</h2>
              <button
                onClick={collapse}
