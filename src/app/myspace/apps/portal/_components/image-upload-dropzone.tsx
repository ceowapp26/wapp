...
const ImageUploadDropzone = React.forwardRef(({ onChange, value, className, disabled, dropzoneOptions, onImageProcessed, ...props }, ref) => {
        ...
        <Popover>
          ...
          <PopoverContent>
            <div className="w-full max-w-[260px] border-small px-1 py-2 rounded-small border-default-200 dark:border-default-100">
              <h3>Choose image options</h3>
              <Listbox aria-label="Actions" onAction={(key) => handleImageProcessing(key)}>
                <ListboxItem key="describe">Describe image</ListboxItem>
                <ListboxItem key="extract">Extract text from image</ListboxItem>
              </Listbox>
            </div>
          </PopoverContent>
        </Popover>
