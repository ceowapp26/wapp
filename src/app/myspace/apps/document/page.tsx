    ...
    <div className="flex flex-col items-center justify-start px-6 pt-16 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-indigo-900 dark:to-purple-900 h-full overflow-auto">
      ...
      >
        <FeatureCard 
          icon={Book} 
          title="Organize" 
          description="Keep your notes organized and easily accessible with intuitive folder structures"
        />
        <FeatureCard 
          icon={Pen} 
          title="Edit" 
      ...
      >
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Start your journey by creating your first note or exploring existing documents
        </p>
      </motion.div>
    </div>
   );
