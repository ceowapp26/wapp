...
const SupportPage = () => {
  return (
    <div className="max-h-screen overflow-y-auto bg-gradient-to-br from-blue-50 to-purple-100 py-12 w-full">
      <Container maxWidth="lg">
        ...
        <Card className="mt-8 bg-white shadow-lg overflow-hidden">
          ...
          <CardBody className="p-6">
            ...
            <Typography variant="body2" className="text-gray-500 hover:text-blue-500 cursor-pointer">
              <Link href="mailto:ceowapp@gmail.com">
