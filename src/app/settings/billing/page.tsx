...
export default function Billing() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 max-h-screen overflow-y-auto">
      <h1 className="text-3xl font-bold mb-8 text-center text-gray-800 dark:text-gray-200">Billing Dashboard</h1>
      <Tabs 
        aria-label="Billing"
        radius="full"
        color="warning"
      ...
      >
        <Tab key="subscription" title={
          ...
          <Card className="rounded-lg shadow-lg">
            <CardBody className="p-8">
              <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-gray-200">Your Subscription</h2>
              <div className="mb-6">
              ...
              <Button 
                ...
                className="w-full max-w-md mx-auto hover:to-red-600 text-white font-bold py-3 rounded-full transition duration-300 ease-in-out transform hover:scale-105 dark:text-gray-800"
              >
                Upgrade Now
              </Button>
            </CardBody>
        ...
        <Tab key="credit" title={
          ...
          <Card className="rounded-lg shadow-lg">
            <CardBody className="p-8">
              <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-gray-200">Your Credit Balance</h2>
              <div className="mb-6">
                <h3 className="text-xl mb-2">
              ...
              <Button 
                ...
                className="w-full max-w-md mx-auto text-white font-bold py-3 rounded-full transition duration-300 ease-in-out transform hover:scale-105 dark:text-gray-800"
              >
                Purchase Credits
              </Button>
            </CardBody>
