...
const ChangelogPage = () => {
  ...
  return (
    <Container maxWidth="lg" className="py-12 h-full bg-transparent max-h-screen overflow-y-auto">
      <Typography variant="h3" className="text-4xl font-bold mb-8 p-2 text-center text-gray-800 dark:text-gray-300">
        Changelog
      </Typography>
