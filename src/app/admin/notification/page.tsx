  ...
  const renderNotificationForm = () => (
    <Box component="form" sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
      ...
      <Select.Root value={notificationType} onValueChange={setNotificationType}>
        <Select.Trigger className="inline-flex items-center justify-between dark:text-gray-800 ounded-md px-4 py-2 text-sm leading-none bg-white border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
