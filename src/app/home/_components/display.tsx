...
const Title = ({ className, delay = 0, ...props }) => (
  <div
    className={cn(
      'group-hover:animate-tile absolute bg-[var(--card-tile-color)] opacity-0 transition-opacity',
...
const Line = ({ className, ...props }) => (
  <div
    className={cn(
      ...
      'group-hover:transition-duration .15s absolute inset-0 opacity-0 transition-opacity duration-350',
      'before:content-[""] before:absolute before:bg-card-line-color before:transition-transform before:duration-350 before:left-0 before:right-0 before:h-[1px] before:transform-origin-[0_50%] before:scale-x-0',
      'after:content-[""] after:absolute after:bg-card-line-color after:transition-transform after:duration-350 after:top-0 after:bottom-0 after:w-[1px] after:transform-origin-[50%_0] after:scale-y-0',
      className
    )}
    {...props}
  />
...
const InfoCard = ({ title, description, icon: Icon }: InfoCardProps) => (
    <div className="group border-0 w-full mx-auto hover:shadow-sm border-2 border-transparent bg-clip-padding rounded-3xl">
    <div className="relative border-2 border-transparent bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 bg-clip-padding rounded-3xl p-10 bg-green-500">
      <div className="flex items-center space-x-4">
        <Icon className="text-white w-16 h-16" />
        <p className="font-semibold text-white tracking-tighter leading-10 text-2xl pt-2">{title}</p>
      </div>
      <p className="font-semibold leading-8 text-sm text-gray-400">{description}</p>
    {/* <div className="group-hover:opacity-100 group-hover:transition duration-500 absolute inset-0 z-10 overflow-hidden opacity-0 transition-opacity before:bg-gradient-to-br before:from-green-400 before:to-blue-500 before:absolute before:left-1/2 before:bottom-2/3 before:w-96 before:h-96 before:rounded-full before:blur-md before:opacity-80 before:transform before:-translate-x-1/2"></div> */}
      <div className="absolute inset-0 overflow-hidden rounded-inherit mask-gradient-card">
        <div className="group-hover:opacity-100 group-hover:transition delay-250 opacity-0 transition-opacity">
          <Title className="top-0 left-0 h-[10%] w-[22.5%]" delay={0} />
          <Title className="top-0 left-[22.5%] h-[10%] w-[27.5%]" delay={-2000} />
          <Title className="top-0 left-[50%] h-[10%] w-[27.5%]" delay={-4000} />
          <Title className="top-0 left-[77.5%] h-[10%] w-[22.5%]" delay={-6000} />
          <Title className="top-[10%] left-0 h-[22.5%] w-[22.5%]" delay={-4000} />
          <Title className="top-[10%] left-[22.5%] h-[22.5%] w-[27.5%]" delay={-6000} />
          <Title className="top-[10%] left-[50%] h-[22.5%] w-[27.5%]" delay={0} />
          <Title className="top-[10%] left-[77.5%] h-[22.5%] w-[22.5%]" delay={-4000} />
          <Title className="top-[25%] left-0 h-[27.5%] w-[22.5%]" delay={-2000} />
        </div>
        <div className="absolute inset-0">
          <Line className="group-hover:transition duration-500 opacity-0 transition-opacity before:top-[10%] after:left-[22.5%]" />
          <Line className="group-hover:transition duration-500 opacity-0 transition-opacity before:top-[32.5%] after:left-[50%]" />
          <Line className="group-hover:transition duration-500 opacity-0 transition-opacity before:top-[55%] after:right-[22.5%]" />
        </div>
      </div>
    </div>
  </div>
...
const DisplaySection = () => {
  return (
    <Box className="bg-white dark:bg-black" sx={{ height: '100%', p: 4 }}>
