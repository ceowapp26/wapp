...
import { defaultEmailAIAPIEndpoint, emailAPIEndpointOptions } from "@/constants/ai";
...
export const useEmailGenerator = ({
  ...
  const apiEndpoint = useMemo(() => {
    ...
    const endpoint = emailAPIEndpointOptions.find(option => option.key === model)?.value;
    setApiEndpoint(endpoint);
    return endpoint;
  }, [inputModel, setApiEndpoint, emailAPIEndpointOptions]);
