...
interface MyspaceContextType {
  ...
  setLeftSidebarHeight: React.Dispatch<React.SetStateAction<number>>;
  ...
  isLoading: boolean;
  setIsLoading: React.Dispatch<React.SetStateAction<boolean>>;
  draggingItem: Doc<"documents"> | null;
  setDraggingItem: React.Dispatch<React.SetStateAction<Doc<"documents"> | null>>;
  targetItem: Doc<"documents"> | null;
  setTargetItem: React.Dispatch<React.SetStateAction<Doc<"documents"> | null>>;
  currentSong: {
    image: string;
    title: string;
    artist: string;
...
export const MyspaceContextProvider: React.FC = ({ children }: { children: React.ReactNode }) => {
  ...
  const [leftSidebarWidth, setLeftSidebarWidth] = useState<number>(0);
  ...
  const [draggingItem, setDraggingItem] = useState<Doc<"documents"> | null>(null);
  const [targetItem, setTargetItem] = useState<Doc<"documents"> | null>(null);
  ...
  return (
    <MyspaceContext.Provider value={{ 
      ...
      leftSidebarHeight, setLeftSidebarHeight, 
